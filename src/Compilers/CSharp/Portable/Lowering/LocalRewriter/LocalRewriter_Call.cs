    ...
    internal sealed partial class LocalRewriter
    {
            ...
            Syntax.SimpleNameSyntax? nameSyntax)
        {
            ...
            if (interceptor.Arity != 0)
            {
                ...
                if (!interceptor.CheckConstraints(new ConstraintsHelper.CheckConstraintsArgs(this._compilation, this._compilation.Conversions, attributeLocation, this._diagnostics)))
                {
                    return;
                }
            }
